...
function counter() {
  ...
  new (function () {
    ...
    return a = n, (i = [{
      ...
      key: "animateElements", value: function (e, t) {
        var r = this;
        e.forEach((function (e) {
          var n = e.target || e, a = r.parseConfig(n);
      ...
      key: "startCounter", value: function (e, t) {
        var r = this, n = (t.end - t.start) / (t.duration / t.delay), a = "inc";
      ...
      key: "parseConfig", value: function (r) {
        var n = this, a = function (r) {
          ...
          return r
        }({}, this.configOptions), i = [].filter.call(r.attributes, (function (e) {
      ...
      key: "convertToCurrencySystem", value: function (e, t) {
        var r = t.currencysymbol || "", n = t.decimals || 1;
